...
from .config import STANDARD_PALETTE, OCCASION_PROFILES, AUDIENCE_PROFILES, _BORDERLINE_FOR_MID, ANNOTATE_MAX
...
__all__ = [
    ...
    "STANDARD_PALETTE", "OCCASION_PROFILES", "AUDIENCE_PROFILES", "_BORDERLINE_FOR_MID", "ANNOTATE_MAX",
